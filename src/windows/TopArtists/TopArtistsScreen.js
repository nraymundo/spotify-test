          ...
          <>
              ...
              <View style={{ marginBottom: 18 }}>
                ...
                <View style={styles.heroCaption}>
                  <View style={styles.heroCaptionLeft}>
                    <Mono size={8} style={{ color: tokens.ink3, marginRight: 8 }}>#1</Mono>
                    <Body size={16} weight={700} numberOfLines={1} style={{ flex: 1 }}>
                      {hero.name}
                    </Body>
                  </View>
                  <Body size={16} weight={700} style={{ color: tokens.accent2 }}>
                    ...
                    <View key={artist.rank} style={styles.tileCell}>
                      ...
                      <View style={{ marginTop: 4, gap: 2 }}>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                          <Mono size={8} style={{ color: tokens.ink3, marginRight: 4 }}>
                            #{artist.rank}
                          </Mono>
            ...
            {tail.map((artist) => (
              <View key={artist.rank} style={styles.tailRow}>
                <Mono size={10} style={{ color: tokens.ink3, width: 18 }}>
                  {artist.rank}
                </Mono>
